...
<div class="min-h-[70vh] flex items-center justify-center px-3 sm:px-4 py-8">
    <div class="card text-center max-w-md w-full animate-fadeInUp">
        ...
        <svg class="error-icon mx-auto text-red-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z"/>
        </svg>
        
        <h1 class="text-6xl sm:text-7xl font-bold text-red-500">403</h1>
        <h2 class="text-xl sm:text-2xl font-bold text-[var(--text-primary)] mt-2">Access Denied</h2>
        ...
        <div class="error-actions mt-4 sm:mt-6 flex flex-wrap justify-center gap-2 sm:gap-3">
            ...
            <a href="{{ route('contact') }}" class="btn btn-outline w-full sm:w-auto text-sm sm:text-base">
                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
