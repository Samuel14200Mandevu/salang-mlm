{{-- resources/views/dashboard/levels/level3.blade.php --}}
@extends('layouts.app')
...
<style>
    ...
    .quick-action-3:hover::after {
        transform: scaleX(1);
    }
    .quick-action-3:hover {
    ...
    .quick-action-3 .label {
        font-size: 0.75rem;
        font-weight: 600;
        color: var(--text-primary);
    }
    
    .rank-progress-3 .fill {
        background: linear-gradient(135deg, #f59e0b, #d97706);
    }
    .rank-progress-bar-3 {
        width: 100%;
    ...
    .top-downline-3:hover { background: var(--bg-hover); transform: translateX(4px); }
    .top-downline-3 .rank {
        width: 1.5rem;
        height: 1.5rem;
        display: flex;
    ...
    .top-downline-3 .rank.gold { background: #f59e0b; color: white; }
    .top-downline-3 .rank.silver { background: #9ca3af; color: white; }
    .top-downline-3 .rank.bronze { background: #d97706; color: white; }
    ...
    .network-level-3:hover { transform: translateY(-2px); }
    .network-level-3.l1 { border-bottom-color: #3b82f6; }
    .network-level-3.l2 { border-bottom-color: #22c55e; }
    .network-level-3.l3 { border-bottom-color: #f59e0b; }
    .network-level-3 .number { font-size: 1.5rem; font-weight: 700; color: #f59e0b; }
    .network-level-3 .label { font-size: 0.65rem; color: var(--text-secondary); text-transform: uppercase; letter-spacing: 0.05em; }
    ...
    .activity-item-3:last-child { border-bottom: none; }
    ...
    @media (max-width: 640px) {
        .stat-card-3 { padding: 0.75rem; }
        .quick-action-3 { padding: 0.75rem; }
        .quick-action-3 .icon { width: 1.25rem; height: 1.25rem; }
        .network-level-3 .number { font-size: 1.25rem; }
        .card-3 { padding: 0.875rem; }
        .top-downline-3 { padding: 0.375rem 0.5rem; }
    }
</style>
@endpush
...
<div class="space-y-4 sm:space-y-6">
    ...
    <div class="welcome-card-3 animate-fadeInUp delay-1">
        <div>
            <h3 class="font-bold text-[var(--text-primary)] text-base sm:text-lg">Cumul Directeur atteint</h3>
            <p class="text-sm text-[var(--text-secondary)]">
                Vous etes maintenant au niveau 3 - Cumul Directeur. Continuez a developper votre reseau
                pour atteindre le niveau 4 - Directeur.
            </p>
    ...
    <div class="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 animate-fadeInUp delay-2">
        ...
        <div class="stat-card-3">
            <div class="flex items-center justify-between">
                <div>
                    <p class="text-[10px] sm:text-xs text-[var(--text-secondary)] uppercase tracking-wider">Top Filleuls</p>
                    <p class="text-lg sm:text-xl md:text-2xl font-bold text-blue-500">{{ $topDownlines->count() }}</p>
                </div>
            ...
            <div class="flex items-center gap-3 sm:gap-4">
                ...
                <div class="min-w-0 flex-1">
                    ...
                    <span class="badge badge-success text-[10px] sm:text-xs inline-block mt-0.5">
                        {{ $currentRankName ?? 'Cumul Directeur' }}
                    </span>
                </div>
            </div>
    ...
    <div class="card-3 animate-fadeInUp delay-5">
        ...
        <div class="rank-progress-bar-3 rank-progress-3">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-3 sm:gap-4 animate-fadeInUp delay-6">
        ...
        <div class="card-3 lg:col-span-2">
    ...
    <div class="grid grid-cols-2 md:grid-cols-4 gap-2 sm:gap-3 animate-fadeInUp delay-7">
        <a href="{{ route('network.index') }}" class="quick-action-3">
            <svg class="icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z"/>
            </svg>
            <span class="label">Mon reseau</span>
        </a>
        <a href="{{ route('commissions.index') }}" class="quick-action-3">
            <svg class="icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/>
            </svg>
            <span class="label">Commissions</span>
        </a>
        <a href="{{ route('subscriptions.index') }}" class="quick-action-3">
            <svg class="icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <a href="{{ route('withdrawal.index') }}" class="quick-action-3">
            <svg class="icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/>
            </svg>
