    ...
    <div class="flex flex-wrap items-center justify-between gap-3 animate-fadeInUp">
        <div>
            <h1 class="text-xl sm:text-2xl md:text-3xl font-bold text-[var(--text-primary)]">
                <span class="text-primary-500">💰</span> Commissions POS
            </h1>
        ...
        <div class="stat-card">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="number text-green-500">${{ number_format($commissionStats['total_amount'] ?? 0, 2) }}</p>
                </div>
        ...
        <div class="stat-card animate-fadeInUp delay-2">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="number text-blue-500">${{ number_format($commissionStats['paid_amount'] ?? 0, 2) }}</p>
                </div>
        ...
        <div class="stat-card animate-fadeInUp delay-3">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="number text-orange-500">${{ number_format($commissionStats['pending_amount'] ?? 0, 2) }}</p>
                </div>
        ...
        <div class="stat-card animate-fadeInUp delay-4">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="number text-purple-500">{{ number_format($commissionStats['total_members'] ?? 0) }}</p>
                </div>
