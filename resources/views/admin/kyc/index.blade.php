...
<style>
    ...
    /* ============================================================
       STYLES DES MODALS (repris du fichier fourni)
       ============================================================ */
    .modal-overlay {
        position: fixed;
        inset: 0;
...
<div class="space-y-4 sm:space-y-6">
    ...
    <div class="flex flex-wrap items-center justify-between gap-3 animate-fadeInUp">
        <div>
            ...
            <p class="text-sm sm:text-base text-[var(--text-secondary)] mt-0.5 sm:mt-1">Gérer les demandes de vérification d'identité</p>
        </div>
    ...
    <div class="grid grid-cols-2 md:grid-cols-4 gap-2 sm:gap-3 animate-fadeInUp delay-1">
        ...
        <div class="card-stats p-3 sm:p-4 border-l-4 border-green-500 animate-fadeInUp delay-2">
            ...
            <p class="text-lg sm:text-xl md:text-2xl font-bold text-green-500">{{ $verifiedCount ?? 0 }}</p>
        </div>
        <div class="card-stats p-3 sm:p-4 border-l-4 border-red-500 animate-fadeInUp delay-3">
            ...
            <p class="text-lg sm:text-xl md:text-2xl font-bold text-red-500">{{ $rejectedCount ?? 0 }}</p>
        </div>
        <div class="card-stats p-3 sm:p-4 border-l-4 border-primary-500 animate-fadeInUp delay-4">
            ...
            <p class="text-lg sm:text-xl md:text-2xl font-bold text-primary-500">{{ $verifiedUsersCount ?? 0 }}</p>
        </div>
    </div>
    ...
    <div class="filters-wrapper flex flex-wrap items-center gap-2 sm:gap-3 animate-fadeInUp delay-5">
        <div class="relative flex-1 min-w-[120px] sm:min-w-[150px] max-w-xs sm:max-w-sm">
            ...
            <input type="text" id="searchInput" placeholder="Rechercher un utilisateur..." class="input pl-7 sm:pl-9 text-sm sm:text-base">
        </div>
                    ...
                    @empty
                        <tr>
                            <td colspan="6" class="text-center py-6 sm:py-8 text-[var(--text-secondary)]">
                                ...
                                <h4 class="text-sm sm:text-base font-semibold text-[var(--text-primary)]">Aucun document KYC</h4>
                                <p class="text-xs sm:text-sm mt-0.5 sm:mt-1">Aucun document n'a été soumis pour le moment</p>
                            </td>
                        </tr>
                    @endforelse
                </tbody>
