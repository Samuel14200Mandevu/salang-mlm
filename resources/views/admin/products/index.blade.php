                ...
                <tbody id="productsTableBody">
                    @forelse($products as $product)
                        <tr class="product-row" 
                            ...
                            <td>
                                <div class="product-image w-8 h-8 sm:w-10 sm:h-10 rounded-lg bg-[var(--bg-secondary)] overflow-hidden flex items-center justify-center">
                            ...
                            <td class="hidden lg:table-cell">
                                <div class="flex flex-wrap gap-1">
                                    ...
                                    @if($product->is_featured)
                                        <span class="badge badge-warning text-[10px] sm:text-xs">Featured</span>
                                    @endif
                                </div>
                            </td>
                            <td class="text-right">
                    ...
                    @empty
                        <tr>
                            <td colspan="8" class="text-center py-6 sm:py-8 text-[var(--text-secondary)] text-sm sm:text-base">
                                ...
                                <p class="text-base sm:text-lg font-medium">No products</p>
                                <p class="text-sm text-[var(--text-tertiary)]">Start by creating your first product</p>
                            </td>
                        </tr>
                    @endforelse
                </tbody>
...
<div id="deleteModal" class="modal-overlay">
    <div class="modal-box">
        ...
        <p class="modal-text">
            Are you sure you want to <strong class="text-danger">permanently delete</strong> <strong id="productNameDisplay"></strong> ?
            <br>
            This action is <strong class="text-danger">irreversible</strong> and all product data will be lost.
        </p>
