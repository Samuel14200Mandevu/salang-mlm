...
<div class="space-y-4 sm:space-y-6">
    ...
    <div class="flex flex-wrap items-center justify-between gap-3 animate-fadeInUp">
        <div>
            <h1 class="text-xl sm:text-2xl font-bold text-[var(--text-primary)]">Rapport des retraits</h1>
            <p class="text-sm text-[var(--text-secondary)] mt-0.5">Analyse détaillée des retraits</p>
        </div>
    ...
    <div class="card animate-fadeInUp delay-1 p-3 sm:p-4">
        <form method="GET" class="filter-grid grid grid-cols-2 md:grid-cols-4 gap-2 sm:gap-3">
            ...
            <div class="flex items-end gap-2 col-span-2">
                ...
                <a href="{{ route('admin.reports.withdrawals') }}" class="btn btn-outline btn-sm flex-1">Réinitialiser</a>
            </div>
        </form>
    </div>
                    ...
                    @empty
                        <tr>
                            <td colspan="7" class="text-center py-6 sm:py-8 text-[var(--text-secondary)] text-sm">
                                ...
                                <p class="text-sm text-[var(--text-tertiary)]">Aucun retrait trouvé</p>
                            </td>
                        </tr>
                    @endforelse
                </tbody>
