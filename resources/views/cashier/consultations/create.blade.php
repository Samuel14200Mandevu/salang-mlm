...
<div class="space-y-4 sm:space-y-6">
    ...
    <form action="{{ route('cashier.members.store') }}" method="POST" id="memberForm">
        ...
        <div class="form-section">
            ...
            <div class="form-row">
                <div class="form-group">
                    <label for="password">Mot de passe <span class="text-xs text-[var(--text-tertiary)]">(optionnel)</span></label>
                    <input type="password" id="password" name="password" class="form-control" placeholder="Laissez vide pour générer automatiquement">
                    <div class="help-text">Minimum 8 caractères. Si non renseigné, un mot de passe par défaut sera généré.</div>
                </div>
                <div class="form-group">
                    <label for="password_confirmation">Confirmer le mot de passe</label>
                    <input type="password" id="password_confirmation" name="password_confirmation" class="form-control" placeholder="Confirmez le mot de passe">
                </div>
            </div>
        </div>
        ...
        <div class="form-section">
            ...
            <p class="text-sm text-[var(--text-secondary)] mb-3">
                Recherchez et sélectionnez le parrain du nouveau membre par code (format 51XXXX) ou son nom.
            </p>

            <div class="form-group sponsor-select-wrapper">
                <label for="sponsor_search">Rechercher un parrain</label>
                <div>
                    <input type="text" id="sponsor_search" class="form-control" placeholder="Code 51XXXX ou nom du parrain" autocomplete="off">
        ...
        <div class="form-section">
            ...
            <div class="form-group" style="margin-top: 0.75rem;">
                <div class="text-sm text-[var(--text-tertiary)]" style="padding: 0.5rem; background: var(--bg-secondary); border-radius: 6px;">
        ...
        <div class="section-company">
            ...
            <div class="form-row-3">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" value="En attente" disabled style="color: #A65A0E; font-weight: 600;">
                </div>
                <div class="form-group">
                    <label>Statut</label>
            ...
            <div class="form-group" style="margin-top: 0.5rem;">
                ...
                <div style="display: flex; align-items: center; gap: 0.75rem; padding: 0.5rem 0.75rem; background: rgba(15, 43, 79, 0.06); border-radius: 8px; border: 1px solid rgba(15, 43, 79, 0.10);">
                    <div style="width: 2.5rem; height: 2.5rem; border-radius: 6px; background: var(--primary-navy); display: flex; align-items: center; justify-content: center; color: white; font-weight: 700; font-size: 1rem; flex-shrink: 0;">
                    ...
                    <span style="font-size: 0.65rem; font-weight: 600; color: var(--primary-navy); background: rgba(15, 43, 79, 0.08); padding: 0.125rem 0.5rem; border-radius: 6px;">
                        CAISSIER
                    </span>
                </div>
    ...
    fetch('{{ route("cashier.search-sponsors") }}?q=' + encodeURIComponent(query))
        ...
        .then(data => {
            ...
            data.forEach(sponsor => {
                ...
                html += `
                    <div class="result-item" onclick="selectSponsor('${sponsor.sponsor_id}', '${sponsor.name.replace(/'/g, "\\'")}', '${sponsor.sponsor_id || ''}', '${sponsor.email || ''}', '${sponsor.phone || ''}')">
...
function selectSponsor(sponsorId, name, sponsorCode, email, phone) {
    sponsorIdInput.value = sponsorCode; // On stocke le code (sponsor_id)
